...
class DeveloperPreview {
    ...
    let state1 = StatisticModel(title: "Market Cap", value: "$12.5Bn", percentageChange: 25.43)
    let state2 = StatisticModel(title: "Total Volume", value: "$1.32Tr")
    let state3 = StatisticModel(title: "Portfolio Value", value: "$50.4K", percentageChange: -12.43)
